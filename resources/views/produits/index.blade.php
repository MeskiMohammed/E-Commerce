...
@section('mini title', 'produits')
@section('adminContent')
<div class="w-full flex flex-col">

    <a href="{{route('produits.create')}}" class="self-end">
        <button type="button" class="bg-cyan-600 hover:bg-cyan-500 cursor-pointer text-white font-bold py-2 px-4 rounded">Ajouter un produit</button>
    </a>
    ...
    <table class="w-full text-center mt-4 h-10 overflow-y-auto">
        ...
        <tbody class="bg-gray-100">
            ...
            @empty
            <tr>
                <td colspan="8" class="rounded-b-2xl p-2 font-bold">pas des produits</td>
            </tr>
            @endforelse
        </tbody>
    </table>
