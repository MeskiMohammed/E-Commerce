...
<div class="w-full flex flex-col">
    ...
    <form action="{{ route('marques.store') }}" method="post" enctype="multipart/form-data" class="w-full flex justify-end items-center">
        @csrf
        <label for="marque">Marque :</label>
        <input type="text" name="marque" class="border rounded m-2">
    ...
    <table class="w-full text-center mt-4 h-10 overflow-y-auto">
        <thead>
            <tr>
                <th class="bg-gray-200 py-2 rounded-tl-2xl">Marque</th>
        ...
        <tbody class="bg-gray-100">
            ...
            @empty
            <tr>
                <td colspan='2' class='rounded-b-2xl p-2 font-bold'>pas des marques</td>
            </tr>
            @endforelse
        </tbody>
        ...
        <tfoot>
            <tr>
                <td colspan="2" ><div class="flex justify-center py-2 rounded-b-xl bg-gray-200">{{$marques->links()}}</div></td>
            </tr>
        </tfoot>
    </table>
</div>
