...
class DetailsCommandeController extends Controller
{
    ...
    {
        return view('details-commandes.index',['detailsCommandes'=> DetailsCommande::all()]);
    }
    ...
    {
        return view('details-commandes.create');
    }
    ...
    {
        return view('details-commandes.modify',$detailsCommande);
    }
